        ...
        <div className="contact-section max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700">info@siomayenak.com</p>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700">Jl. Siomay Enak No. 123, Jakarta Selatan</p>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700">Setiap Hari: 10:00 - 21:00 WIB</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <a
                href="https://wa.me/6281234567890?text=Halo,%20saya%20ingin%20bertanya%20tentang%20Siomay%20Enak"
                target="_blank"
